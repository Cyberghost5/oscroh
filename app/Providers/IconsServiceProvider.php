...
class IconsServiceProvider extends ServiceProvider
{
    ...
    public static function readSvgContent($icon)
    {
        $paths = [
            ...
            public_path("/libs/ionicons/dist/ionicons/svg/{$icon}.svg"),
            base_path("/node_modules/ionicons/dist/svg/{$icon}.svg"),
            base_path("/node_modules/ionicons/dist/ionicons/svg/{$icon}.svg"),
        ...
        return '<ion-icon name="'.e($icon).'"></ion-icon>';
    }
}
