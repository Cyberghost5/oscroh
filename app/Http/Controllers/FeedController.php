...
class FeedController extends Controller
{
    ...
    public function buildPublicFeedData(Request $request): array
    {
        ...
        JavaScript::put([
            'paginatorConfig' => [
                'next_page_url' => str_replace('/public-feed?page=', '/public-feed/posts?page=', $posts->nextPageUrl()),
                'prev_page_url' => str_replace('/public-feed?page=', '/public-feed/posts?page=', $posts->previousPageUrl()),
                'current_page'  => $posts->currentPage(),
                'total'         => $posts->total(),
                'per_page'      => $posts->perPage(),
                'hasMore'       => $posts->hasMorePages(),
