...
class GenericController extends Controller
{
    ...
    public function saveLicense(Request $request) {
        try{
            $licenseCode = (string) $request->get('product_license_key', '');
            ...
            return response()->json(['success' => true, 'message' => __("License settings updated")], 200);
    ...
    public function createStorageSymlink(Request $request) {
        try {
            ...
            return response()->json(['success' => true, 'message' => __("Storage symlink created successfully")], 200);
