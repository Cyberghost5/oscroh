...
<div class="flex-fill">
    ...
    <div class="container-xl px-0">
        <div class="d-flex flex-wrap main-wrapper">
            ...
            <div class="col-12 col-md-9 {{(!in_array(Route::currentRouteName(),['my.messenger.get']) ? 'min-vh-100' : '' )}}  border-left px-0 content-wrapper {{(in_array(Route::currentRouteName(),['feed', 'feed.public', 'profile','my.messenger.get','search.get','my.notifications','my.bookmarks','my.lists.all','my.lists.show','my.settings','posts.get']) ? '' : 'border-right' )}}">
                @yield('content')
            </div>
        </div>
